...
Si precisa, inoltre, che esiste un metodo \texttt{.consume} che parte da una Thing Description per creare un oggetto: nel caso dei test effettuati, non sembra però produrre il risultato atteso, in quanto produce una Thing non coerente con la descrizione, lasciando alcuni dei campi non valorizzati, nonostante la loro palese presenza.
