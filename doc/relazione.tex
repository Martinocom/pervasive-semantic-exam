...
La procedura di installazione del framework può essere seguita direttamente sul suo \href{https://github.com/eclipse/thingweb.node-wot/}{repository} \cite{thingweb}. I seguenti passaggi sono stati effettuati sul sistema operativo Windows 10. Si vuole notare, inoltre, che \texttt{ThingWeb.io} offre il cosiddetto \href{http://plugfest.thingweb.io/playground/}{\textbf{Playground}} per creare e validare la struttura di una Thing Description.\\
...
Successivamente, viene seguito il tutorial per lanciare un progetto \textit{stand-alone}:
\begin{lstlisting}[language=bash]
	# Clonazione progetto
