...
\section{Dettagli sulle rimanenti Web Thing}
Non ci sono dettagli relativi alle differenze tra Thing \textit{non-semantiche}, tranne la completa assenza delle \texttt{actions} in alcune di esse;  per quelle \textit{semantiche} è opportuno invece sottolineare alcuni punti essenziali:
...
\begin{itemize}
	...
	\item le tre osservazioni sopra fanno emergere la necessità di estensione dell'ontologia, per definire meglio i collegamenti semantici che vi possono essere tra di esse.
\end{itemize}
