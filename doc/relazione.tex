...
Prima di procedere a codificare gli oggetti, è utile definire in principio le Thing Description caratterizzanti gli oggetti indicati nella sezione \ref{sec:modellazione-things}. Inoltre, come già definito nel capitolo \ref{sec:ontologie_note}, è possibile far riferimento a più documenti che definiscono lo standard: per essere compliant al framework, si preferisce utilizzare il riferimento di Mozilla \cite{mozilla-iot} per questo standard, anche se in versione \quotes{\textit{non ufficiale}}.\\
...
\begin{itemize}
	...
	\item \textbf{Lampadina}: \texttt{attachments/td/lamp.json}
