...
Il programmatore dev'essere a conoscenza delle proprietà e azioni che una Thing può svolgere: è infatti al momento impossibile creare Web Things capaci di auto-configurarsi completamente; se si dovesse dimenticare di inserire all'interno del codice variabili e riferimenti ai handler, le proprietà saranno comunque accessibili, ma il loro valore rimarrà sempre nullo.
