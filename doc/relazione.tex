...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%non numera l'ultima pagina sinistra
\clearpage{\pagestyle{empty}\cleardoublepage}
\chapter{Definizione di Smart Descripted Things}           %crea il capitolo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%imposta l'intestazione di pagina
\lhead[\fancyplain{}{\bfseries\thepage}]{\fancyplain{}{\bfseries\rightmark}}  

Considerando l'insieme delle possibilità scoperte, si procede di conseguenza alla definizione e creazione delle Things. È utile coniare un nuovo termine, ovvero quello di \textbf{Smart \textit{\underline{Descripted}} Things}, per far riferimento agli oggetti non soltanto Smart, ma anche aventi informazioni tali da essere compliant alla Thing Description.
