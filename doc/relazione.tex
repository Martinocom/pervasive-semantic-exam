...
L'elenco completo delle \textit{issues} aperte nei repository di diversi framework è il seguente:
...
È da sottolineare però l'impegno della comunità a risolvere questi problemi: infatti, anche se non ampiamente attiva, essa continua a mantenere e sviluppare nuove funzionalità di questo framework. Le \textit{issues} aperte nei rispettivi \textit{repository} hanno ricevuto un'immediata risposta e il messaggio subliminale mandato da chi rispondeva tramandava una forte volontà di risolvere le problematiche poste.
